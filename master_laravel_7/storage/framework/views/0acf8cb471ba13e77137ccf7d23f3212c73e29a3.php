...
<head>
    ...
    <!-- Morris Chart Styles-->
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/js/morris/morris-0.4.3.min.css"/>
    <!-- Custom Styles-->
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/custom-styles.css"/>
    <!-- Google Fonts-->
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/http://fonts.googleapis.com/css?family=Open+Sans" type='text/css'/>
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/js/Lightweight-Chart/cssCharts.css"/> 
</head>
...
<body>
        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><strong>
                    <i class=<img src=" <?php echo e(asset('frontend')); ?>/images/jpg" alt="....." class="img-circle profile_img">>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   <li>
                        <a href="tab-panel.html"><a class="nav-link" href="<?php echo e(('medicalcenter-master')); ?>/index.html">
                       <i class="fa fa-qrcode"></i>Home</a>
                    </li>
                    <li>
                        <a href="tab-panel.html"><a class="nav-link" href="<?php echo e(('colorlib-regform-4')); ?>/index.html">
    ...
    <!-- JS Scripts-->
    <!-- jQuery Js -->
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/jquery-1.10.2.js"></script>
    <!-- Bootstrap Js -->
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/bootstrap.min.js"></script>
	 
    <!-- Metis Menu Js -->
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/jquery.metisMenu.js"></script>
    <!-- Morris Chart Js -->
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/morris/raphael-2.1.0.min.js"></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/morris/morris.js"></script>
	
	
	<script src="<?php echo e(asset('frontend')); ?>/assets/js/easypiechart.js"></script>
	<script src="<?php echo e(asset('frontend')); ?>/assets/js/easypiechart-data.js"></script>
	
	 <script src="<?php echo e(asset('frontend')); ?>/assets/js/Lightweight-Chart/jquery.chart.js"></script>
	
    <!-- Custom Js -->
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/custom-scripts.js"></script>

      
    <!-- Chart Js -->
    <script type="<?php echo e(asset('frontend')); ?>/assets/text/javascript" src="assets/js/Chart.min.js"></script>  
    <script type="<?php echo e(asset('frontend')); ?>/assets/text/javascript" src="assets/js/chartjs.js"></script> 

</body>

</html><?php /**PATH C:\laravel\master_laravel_7\resources\views/layouts/master.blade.php ENDPATH**/ ?>