...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="<?php echo e(url('frontend/images/icon/logo.png')); ?>" alt="CoolAdmin" />
                        </a>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                       <li class="has-sub">
                            <a class="js-arrow" href="#" ><a class="nav-link" href="<?php echo e(('layouts')); ?>/home.php">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="<?php echo e(url('frontend/images/icon/logo_Gosehat_.png')); ?>" alt="Go Sehat" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    ...
                    <li class="has-sub">
                            <a class="js-arrow" href="#" ><a class="nav-link" href="<?php echo e(('health')); ?>/index.html">
                                <i class="fas fa-home"></i>Home</a>
                        </li>
                        </li>
                        <li>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo e(url('frontend/images/icon/divv.jpg')); ?>" alt="Diva Yulliana" />
                                        </div>
                                        <div class="content">
...
<!-- end document-->
<?php /**PATH C:\Users\hp\Documents\Laravel\resources\views/layouts/master.blade.php ENDPATH**/ ?>